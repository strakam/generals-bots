...
def main():
    ...
    num_steps = 256  # Longer rollouts help with sparse rewards
    num_iterations = 1000
    lr = 3e-4
    ...
    for iteration in range(num_iterations):
        ...
        # infos is a NamedTuple, need to stack each field
        ...
        if iteration % 10 == 0:
            ...
            wins = int(jnp.sum((dones) & (infos.winner == 0)))  # Count p0 wins
            losses = int(jnp.sum((dones) & (infos.winner == 1)))  # Count p1 wins
