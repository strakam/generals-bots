...
# A castle earns +1 army every even tick (0.5/turn), so a ~35-army castle needs
# roughly 70 turns to pay for itself. Past this point in a 1200-turn match the
# army is better spent attacking. Deathtouch also opens at turn 800.
LAST_BUILD_TURN = 700

# Each castle we own raises the price of the next one nearby, and every turn
# spent saving is a turn not expanding. Three is a cheap, bounded investment.
MAX_CASTLES = 3
